...
function About() {
  return (
    <div className='h-[100%] flex flex-col'>
      <div className='pt-3 sm:h-1/6 sm:flex sm:flex-col sm:justify-center'>
        <p className='text-3xl'>Born in Barcelona in 1990, Francisco Luis Matte .</p>
      </div>

      <div className=' sm:flex sm:flex-col sm:justify-evenly'>
        ...
        <div className='ss:flex ss:justify-center'>
          <img src={`${Fran}`} alt="fran" className='px-2 pt-2 ss:w-1/2'/>
        </div>
      </div>
    </div>
  );
