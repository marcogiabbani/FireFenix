...
function About() {
  return (
    <div className='h-[100%] flex flex-col md:flex-row md:justify-around md:h-[80%]'>


      <div className='pt-3 px-2 sm:h-1/6 sm:flex sm:flex-col sm:justify-center md:h-[100%] md:px-6 md:pb-24'>
        <p className='text-3xl font-[NeueHaasGrotDisp65Medium] md:text-2xl'>Born in Barcelona in 1990, Francisco Luis Matte .</p>
        <div className=' pt-2 md:text-xl'>
